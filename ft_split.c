...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/28 14:42:39 by ldiogo            #+#    #+#             */
/*   Updated: 2022/03/07 14:38:43 by ldiogo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	char	**strings(char **strarray, char *s, char c, int i)
{
	int	start;
	int	end;
	int	a;
...
char	**ft_split(const char *s, char c)
{
	...
	if (!strarray)
		return (0);
	strarray = strings(strarray, (char *)s, c, i);
	return (strarray);
}
